...
/**
 * Created by qizhenghao on 2016-08-01 16:58:49.
 */
public class DesktopBottomTabLayout extends LinearLayout {
    ...
    private String mTitles[] = {
            getContext().getString(R.string.travels),
            getContext().getString(R.string.discover),
    ...
    public DesktopBottomTabLayout(Context context) {
        this(context, null);
    }

    public DesktopBottomTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DesktopBottomTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void populateTabLayout() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            final View tabView = LayoutInflater.from(getContext()).inflate(R.layout.desktop_bottom_tabs_layout, this, false);
